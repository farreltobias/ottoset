  ...
  return (
    <>
      <section className="container mx-auto mt-12 mb-36 lg:mt-24 lg:mb-72">
        ...
        <Text variant="p2">
          A sua privacidade é importante para nós. É política do Ottoset
          respeitar a sua privacidade em relação a qualquer informação sua que
          possamos coletar no site Ottoset, e outros sites que possuímos e
          operamos.
          <br />
          <br />
          ...
          informação que o Ottoset oferece no site e com caráter enunciativo,
          mas não limitativo:
          <br />
          <br />
